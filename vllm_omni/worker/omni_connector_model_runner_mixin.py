...
def should_accumulate_full_payload_output(model_config, custom_process_func) -> bool:
    ...
    A client-visible final output may still feed another stage (for example,
    DuplexOmni Thinker-D emits text and Talker conditioning), so
    ``final_output`` is not a terminal-stage gate here.
    """
